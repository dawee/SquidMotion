...
class Channel extends React.Component {
  ...
  onClick(evt) {
    ...
    actions.selectTime(this.props.fileId, this.props.channelId, time);
  }
  ...
  onDoubleClick(evt) {
    ...
    actions.createAndSelectStep(this.props.fileId, this.props.channelId, time);
  }
      ...
      TableRow.el(null,
        ...
        TableRowColumn.el({style: style.gridColumn, key: 'second'},
          svg.el({
            ...
            onDoubleClick: this.boundDoubleClick,
          },
            Ruler.el({
              withLabels: false,
              withSizing: false,
