...
class SVGImage extends React.Component {
  ...
  constructor(props) {
    ...
    this.documentStore = DocumentStore.get(this.props.fileId);

    DocumentStore.factory.on('change', this.onDocumentFactoryChange.bind(this));
    this.initState();
  }
  ...
  getDocumentState() {
    const documentStore = DocumentStore.get(this.props.fileId);
